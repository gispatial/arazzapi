...
public $date_updated;
	...
	function search($searchKey){
		...
		// select all query
		$query = "SELECT  t.* FROM ". $this->table_name ." t  WHERE t.ic_no LIKE ? OR t.document_code LIKE ?  OR t.filename LIKE ?  OR t.ori_filename LIKE ?  OR t.file_path LIKE ?  OR t.date_updated LIKE ?  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
...
$this->date_updated = $row['date_updated'];
	...
	function create(){
		...
		$query ="INSERT INTO ".$this->table_name." SET ic_no=:ic_no,document_code=:document_code,filename=:filename,ori_filename=:ori_filename,file_path=:file_path,date_updated=:date_updated";
...
$stmt->bindParam(":date_updated", $this->date_updated);
	...
	function update(){
		...
		// update query
		$query ="UPDATE ".$this->table_name." SET ic_no=:ic_no,document_code=:document_code,filename=:filename,ori_filename=:ori_filename,file_path=:file_path,date_updated=:date_updated WHERE ic_no = :ic_no";
