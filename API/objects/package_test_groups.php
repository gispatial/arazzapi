...
public $remark;
	...
	function search($searchKey){
		...
		// select all query
		$query = "SELECT  t.* FROM ". $this->table_name ." t  WHERE t.package_code LIKE ? OR t.test_group_code LIKE ?  OR t.test_location LIKE ?  OR t.total_test_conducted LIKE ?  OR t.remark LIKE ?  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
...
$this->remark = $row['remark'];
	...
	// create package_test_groups
	function create(){
	 
		// query to insert record
		$query ="INSERT INTO ".$this->table_name." SET package_code=:package_code,test_group_code=:test_group_code,test_location=:test_location,total_test_conducted=:total_test_conducted,remark=:remark";
...
$stmt->bindParam(":remark", $this->remark);
	...
	function update(){
		...
		// update query
		$query ="UPDATE ".$this->table_name." SET package_code=:package_code,test_group_code=:test_group_code,test_location=:test_location,total_test_conducted=:total_test_conducted,remark=:remark WHERE package_code = :package_code";
...
$stmt->bindParam(":package_code", $this->package_code);
	...
	// delete the package_test_groups
	function delete(){
