...
// instantiate package_test_panels object
...
$package_test_panels->remark = $data->remark;
 	$lastInsertedId=$package_test_panels->create();
    // create the package_test_panels
    if($lastInsertedId!=0){
    ...
    // if unable to create the package_test_panels, tell the user
    else{
        ...
        // tell the user
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create package_test_panels","document"=> ""));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create package_test_panels. Data is incomplete.","document"=> ""));
}
?>
