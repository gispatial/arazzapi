...
// get id of company_document to be edited
$data = json_decode(file_get_contents("php://input"));
 
// set ID property of company_document to be edited
...
// if unable to update the company_document, tell the user
else{
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update company_document","document"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update company_document. Data is incomplete.","document"=> ""));
}
?>
