...
// instantiate package_patient object
...
$package_patient->doc_required = $data->doc_required;
 	$lastInsertedId=$package_patient->create();
    // create the package_patient
    if($lastInsertedId!=0){
    ...
    // if unable to create the package_patient, tell the user
    else{
        ...
        // tell the user
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create package_patient","document"=> ""));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create package_patient. Data is incomplete.","document"=> ""));
}
?>
