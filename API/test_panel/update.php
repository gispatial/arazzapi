...
// get id of test_panel to be edited
$data = json_decode(file_get_contents("php://input"));
 
// set ID property of test_panel to be edited
...
// if unable to update the test_panel, tell the user
else{
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update test_panel","document"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update test_panel. Data is incomplete.","document"=> ""));
}
?>
