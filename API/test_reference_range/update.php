...
// get id of test_reference_range to be edited
$data = json_decode(file_get_contents("php://input"));
 
// set ID property of test_reference_range to be edited
...
if($test_reference_range->update()){
...
// if unable to update the test_reference_range, tell the user
else{
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update test_reference_range","document"=> ""));
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to update test_reference_range. Data is incomplete.","document"=> ""));
}
?>
