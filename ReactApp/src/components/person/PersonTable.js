...
import getColumns from './PersonColumns';
import Edit from "@material-ui/icons/Edit";
import {withRouter} from "react-router";
import {AddBox} from "@material-ui/icons";
import {deletePerson, getPerson} from "../../repo/personRepo";
/*
...
const PersonTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getPerson(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/person/update/${rowData.ic_no}`,
                        user:rowData
                    })
                }
            },
...
export default withRouter(PersonTable);
import MaterialTable from 'material-table';
import React, {useEffect, useState} from 'react';
import tableIcons from '../templates/TableIcons';
import getColumns from './PersonColumns';
