...
import {deleteCompany, getCompany} from "../../repo/companyRepo";
/*
...
const CompanyTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getCompany(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/company/update/${rowData.co_id}`,
                        user:rowData
                    })
                }
            },
