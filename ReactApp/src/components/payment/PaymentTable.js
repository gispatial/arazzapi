...
import {deletePayment, getPayment} from "../../repo/paymentRepo";
/*
...
const PaymentTable = (props) => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getPayment(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/payment/update/${rowData.ref_no}`,
                        user:rowData
                    })
                }
            },
