...
import getColumns from './RegistrationColumns';
import Edit from "@material-ui/icons/Edit";
import {withRouter} from "react-router";
import {AddBox} from "@material-ui/icons";
import {deleteRegistration, getRegistration} from "../../repo/registrationRepo";
/*
...
const RegistrationTable = (props) => {
    ...
    const handleRowDelete = (oldData, resolve) => {
        deleteRegistration(oldData.ERROR_NOPRIMARYKEYFOUND)
            .then(res => {
                resolve()
            })
            .catch(error => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getRegistration(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/registration/update/${rowData.ERROR_NOPRIMARYKEYFOUND}`,
                        user:rowData
                    })
                }
            },
