...
import {deleteBooking, getBooking} from "../../repo/bookingRepo";
/*
...
const BookingTable = (props) => {
    ...
    const handleRowDelete = (oldData, resolve) => {
        deleteBooking(oldData.booking_no)
            .then(res => {
                resolve()
            })
            .catch(error => {
    ...
    <MaterialTable
        ...
        data={async(query)=>
            {
                const res = await getBooking(query.page,query.pageSize,query.search);
                return ({
                    data: res.records,
                    page: query.page,
        ...
        actions={[
            {
                ...
                onClick: (event,rowData) =>{
                    history.push({
                        pathname:`/booking/update/${rowData.booking_no}`,
                        user:rowData
                    })
                }
            },
